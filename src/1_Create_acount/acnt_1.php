...
<br><br>
ニックネーム:　<input type="text" name="name"placeholder="パスワードを入力してください">
<br><br>
...
性別　　　　　<input type= "radio"name="meal" value="man">男性
<input type= "radio"name="meal" value="woman">女性
<input type= "radio"name="meal" value="lgbt">無回答<br><br>
<div class="box">
    職業　　　　　<select name="job">
